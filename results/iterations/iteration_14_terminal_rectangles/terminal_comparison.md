# 预测码头与真实码头对比：iteration_14_terminal_rectangles
...
| 预测面积大于真实面积 | 332 (68.9%) |
| 面积比中位数 | 1.960 |
| 面积比 P25 / P75 | 0.768 / 3.968 |
| 面积在真实面积 0.5--2 倍内 | 163 (33.8%) |
...
| 真实码头发现率 | 至少与一个预测面有效相交的真实码头 / 全部真实码头 | 650 / 922 (70.5%) |
| 合格空间关系对 | 所有有效相交的预测/真实面组合 | 861 |
